...
PRE=/test_program_log/$1/$1_
SUF=_0
g++ test_program_fastswap.cpp -O2 -g -o test_program_fastswap -lpthread
...
./test_program_fastswap $2 $3 $4 ${PRE}${5}${SUF} ${PRE}${6}${SUF} ${PRE}${7}${SUF} ${PRE}${8}${SUF} 
