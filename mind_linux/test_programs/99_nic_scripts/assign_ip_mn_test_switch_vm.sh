#!/bin/bash
sudo ip addr add 10.10.21.51/32 dev ens10
...
ip route add 10.10.21.0/24 dev ens10
sudo arp -i ens10 -s 10.10.21.221 00:22:aa:44:55:6d
ping -c 3 10.10.21.221	# memory vm
